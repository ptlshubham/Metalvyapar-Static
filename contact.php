...
require './PHPMailer.php';
    ...
    $mail->Username   = 'support@metalvyapar.com';       // SMTP username
    $mail->Password   = "Nextgen@123";                           // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 465;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
    
    $form_name = $_REQUEST['firstname'];
    $last_name = $_REQUEST['lastname'];
    $contact_company = $_REQUEST['company'];
    $contact_email = $_REQUEST['email'];
    $contact_subject = $_REQUEST['subject'];
    $contact_message = $_REQUEST['message'];
    
    //Recipients
    $mail->setFrom('support@metalvyapar.com', 'Contact Us');
    $mail->addAddress($contact_email, $form_name); 
    $mail->addAddress('support@metalvyapar.com', 'Contact Us'); 

    $servername = "191.101.80.162:9000";
    $username = "root";
    ...
    $sql = "INSERT INTO `contact`(`email`, `name`, `subject`, `message`, `isactive`, `btn`, `bg_color`, `createddate`) VALUES
    ('$contact_email', '$contact_company', '$contact_subject', '$contact_message',true,'Contact Us','bg-warning',CURRENT_TIMESTAMP);";
                                                                            ...
                                                                            <td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
                                                                               ...
                                                                               Dear <b>'.$form_name . $last_name.'</b><br>
                                                                                  ...
                                                                                  <ul>
                                                                                     ...
                                                                                     <li><strong>Company Name</strong> - '.$contact_company.'</li>
